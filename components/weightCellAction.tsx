...
interface WeightCellActionProps {
  data: SizeColumn;
}

export const WeightCellAction: FC<WeightCellActionProps> = ({ data }) => {
  ...
  const onCopy = (id: string) => {
    ...
    toast.success('Weight id copied to the clipboard');
  };
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error('Make sure you removed all products using this weight first');
    } finally {
      setLoading(false);
      setOpen(false);
    }
